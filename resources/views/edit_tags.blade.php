	...
	<div class="min-h-screen bg-gray-100 px-4 py-16">
		<div class="mx-auto w-full max-w-4xl">
			<div class="mb-6 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
				<p class="text-xs uppercase tracking-[0.2em] text-gray-500">Tags bewerken</p>
				<h1 class="text-3xl font-semibold text-gray-900">Pas tags aan voor je auto</h1>
				<p class="mt-2 text-sm text-gray-600">
					Kies de tags die het aanbod het beste beschrijven.
				</p>
